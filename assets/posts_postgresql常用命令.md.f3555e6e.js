import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.676e9b8e.js";const g=JSON.parse('{"title":"postgresql 常用命令","description":"postgresql 常用命令","frontmatter":{"title":"postgresql 常用命令","description":"postgresql 常用命令","date":"2024-07-01T00:00:00.000Z","tags":["linux","sql"]},"headers":[],"relativePath":"posts/postgresql常用命令.md","filePath":"posts/postgresql常用命令.md","lastUpdated":1721285897000}'),p={name:"posts/postgresql常用命令.md"},o=l(`<blockquote><p>参考资料: <a href="https://www.cnblogs.com/my-blogs-for-everone/p/10226473.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/my-blogs-for-everone/p/10226473.html</a><a href="https://ken.io/note/macos-postgresql-install-and-configuration" target="_blank" rel="noreferrer">https://ken.io/note/macos-postgresql-install-and-configuration</a></p></blockquote><h1 id="mac-命令" tabindex="-1">mac 命令 <a class="header-anchor" href="#mac-命令" aria-label="Permalink to &quot;mac 命令&quot;">​</a></h1><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;"># 退出psql</span></span>
<span class="line"><span style="color:#6F42C1;">\\q</span></span></code></pre></div>`,5),e=[o];function c(t,r,i,y,E,F){return n(),a("div",null,e)}const h=s(p,[["render",c]]);export{g as __pageData,h as default};
